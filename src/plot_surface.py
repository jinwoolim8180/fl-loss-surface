...
def crunch(surf_file, net, w, s, d, dataloaders, loss_key, acc_key, comm, rank, args):
    """
...
if __name__ == '__main__':
    ...
    net = models.get_model(args)
    net.load_state_dict(server.model_parameters)
    ...
    total_train_dataset = get_dataset(args, 'train')
    trainloaders = []
    ...
    #--------------------------------------------------------------------------
    crunch(surf_file, net, w, s, d, trainloaders, 'train_loss', 'train_acc', comm, rank, args)
