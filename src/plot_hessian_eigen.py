...
if __name__ == '__main__':
    ...
    parser.add_argument('--x', default='-1:1:9', help='A string with format xmin:x_max:xnum')
    ...
    trainloader = DataLoader(train_dataset, args.batch_size, shuffle=True, num_workers=0)
